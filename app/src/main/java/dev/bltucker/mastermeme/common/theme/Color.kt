...
val Primary = Color(0xFFD0BCFF)  // Purple from FAB
...
val Background = Color(0xFF1C1B1E)  // Dark background from Figma
...
val GradientStart = Color(0xFFEADDFF)
val GradientEnd = Color(0xFFD0BCFE)